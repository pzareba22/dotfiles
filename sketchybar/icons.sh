...
export ICON_TERM=󰆍 # fallback terminal app, terminal, warp, iterm2, alacritty
...
export ICON_WEB=󰇧 # safari, beam, duckduckgo, arc, edge, chrome, brave
export ICON_FIREFOX= # firefox
